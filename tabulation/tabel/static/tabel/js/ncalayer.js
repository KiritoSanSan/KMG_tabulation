...
function blockScreen() {
    $.blockUI({
        // message: '<img src="graph/js/loading.gif" /><br/>Подождите, выполняется операция в NCALayer...',
        message: '<img src="tabulation\graph\static\graph\js\loading.gif" /><br/>Подождите, выполняется операция в NCALayer...',
        css: {
            border: 'none',
            padding: '15px',
            backgroundColor: '#000',
